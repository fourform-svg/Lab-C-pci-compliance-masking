...
Design & Plan:
    ...
    Discovery: Enable Amazon Macie to scan RDS snapshots exported to S3. Macie finds PAN, SSN, Email -> pushes findings to Security Hub.
...
Execution Steps:
 ...
 Before/after query screenshots, Macie findings JSON, and Audit Manager compliance score to be attached.
